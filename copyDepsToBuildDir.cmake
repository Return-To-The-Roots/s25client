...
ELSE()
	message(STATUS "Host system is not Unix. Will use copies instead of symlinks")
    ...
    if(NOT EXISTS ${CUR_OUTPUT_DIR}/DATA)
        ...
        if(S2_DATA_DIR)
            file(COPY ${S2_DATA_DIR}/ DESTINATION ${CUR_OUTPUT_DIR}/DATA)
        endif()
    endif()
    if(NOT EXISTS ${CUR_OUTPUT_DIR}/GFX)
        find_path(S2_GFX_DIR GFX/PALETTE/PAL5.BBM PATHS ${S2_GAME_PATHS})
        if(S2_GFX_DIR)
            file(COPY ${S2_GFX_DIR}/ DESTINATION ${CUR_OUTPUT_DIR}/GFX)
        endif()
    endif()
ENDIF()