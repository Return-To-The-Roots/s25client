...
BOOST_AUTO_TEST_CASE(GetAllNeighboursUnion) 
{
    ...
    std::vector<MapPoint> expectedResultPoints{
        ...
        MapPoint(10, 9),
        MapPoint(9, 10),
        MapPoint(11, 10), // Duplicate
        MapPoint(9, 11), // Duplicate
        MapPoint(11, 11),
        MapPoint(10, 12),
        MapPoint(11, 12)
    };
    ...
    {
        BOOST_REQUIRE_MESSAGE(std::find(resultPoints.begin(), resultPoints.end(), *pointIt) != resultPoints.end(), "Failed searching for: " << *pointIt);
    }
}
