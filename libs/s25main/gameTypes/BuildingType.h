...
const std::map<std::string, BuildingType> BUILDING_NAME_MAP = {
  {"Headquarters", BuildingType::Headquarters},
  {"Barracks", BuildingType::Barracks},
  {"Guardhouse", BuildingType::Guardhouse},
  {"Nothing2", BuildingType::Nothing2},
  {"Watchtower", BuildingType::Watchtower},
  {"Vineyard", BuildingType::Vineyard},
  {"Winery", BuildingType::Winery},
  {"Temple", BuildingType::Temple},
  {"Nothing6", BuildingType::Nothing6},
  {"Fortress", BuildingType::Fortress},
  {"GraniteMine", BuildingType::GraniteMine},
  {"CoalMine", BuildingType::CoalMine},
  {"IronMine", BuildingType::IronMine},
  {"GoldMine", BuildingType::GoldMine},
  {"LookoutTower", BuildingType::LookoutTower},
  {"Nothing7", BuildingType::Nothing7},
  {"Catapult", BuildingType::Catapult},
  {"Woodcutter", BuildingType::Woodcutter},
  {"Fishery", BuildingType::Fishery},
  {"Quarry", BuildingType::Quarry},
  {"Forester", BuildingType::Forester},
  {"Slaughterhouse", BuildingType::Slaughterhouse},
  {"Hunter", BuildingType::Hunter},
  {"Brewery", BuildingType::Brewery},
  {"Armory", BuildingType::Armory},
  {"Metalworks", BuildingType::Metalworks},
  {"Ironsmelter", BuildingType::Ironsmelter},
  {"Charburner", BuildingType::Charburner},
  {"PigFarm", BuildingType::PigFarm},
  {"Storehouse", BuildingType::Storehouse},
  {"Nothing9", BuildingType::Nothing9},
  {"Mill", BuildingType::Mill},
  {"Bakery", BuildingType::Bakery},
  {"Sawmill", BuildingType::Sawmill},
  {"Mint", BuildingType::Mint},
  {"Well", BuildingType::Well},
  {"Shipyard", BuildingType::Shipyard},
  {"Farm", BuildingType::Farm},
  {"DonkeyBreeder", BuildingType::DonkeyBreeder},
  {"HarborBuilding", BuildingType::HarborBuilding},
};
