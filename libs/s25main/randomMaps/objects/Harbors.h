...
private:
    ...
    int minimumIslandSize_;
    int minimumCoastSize_;
    int maximumIslandHarbors_;

    bool IsSuitableHarborPosition(const CoastTile& pos,
...
public:
    ...
    Harbors(int minimumIslandSize, int minimumCoastSize, int maximumIslandHarbors);
