...
public:
    ...
    void Msg_TableRightButton(unsigned ctrl_id, const std::optional<unsigned>& selection) override;
    void Msg_TableLeftButton(unsigned ctrl_id, const std::optional<unsigned>& selection) override;
