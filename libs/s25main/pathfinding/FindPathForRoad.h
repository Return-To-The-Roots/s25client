...
inline std::vector<Direction> FindPathForRoad(const GameWorldBase& world, const MapPoint startPt, const MapPoint endPt, bool isBoatRoad,
                                              unsigned maxLen = 100)
{
    return detail::FindPathForRoad(world, startPt, endPt, isBoatRoad, maxLen);
}
inline std::vector<Direction> FindPathForRoad(const GameWorldViewer& world, const MapPoint startPt, const MapPoint endPt, bool isBoatRoad,
                                              unsigned maxLen = 100)
{
    return detail::FindPathForRoad(world, startPt, endPt, isBoatRoad, maxLen);
}
