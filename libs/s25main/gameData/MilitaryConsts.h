...
const int NUM_TROOPSS[NUM_NATS][4] = {{2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}};
...
const DrawPointInit TROOPS_FLAG_OFFSET[NUM_NATS][4] = {{{24, -41}, {19, -41}, {31, -88}, {35, -67}},
...
const DrawPointInit TROOPS_FLAG_HQ_OFFSET[NUM_NATS] = {{-12, -102}, {-19, -94}, {-18, -112}, {20, -54}, {-33, -81}};

/// Offset of the border indicator flag per nation from the buildings origin
const DrawPointInit BORDER_FLAG_OFFSET[NUM_NATS][4] = {{{-6, -36}, {7, -48}, {-18, -28}, {-47, -64}},
...
const unsigned char HITPOINTS[NUM_NATS][5] = {{3, 4, 5, 6, 7}, {3, 4, 5, 6, 7}, {3, 4, 5, 6, 7}, {3, 4, 5, 6, 7}, {3, 4, 5, 6, 7}};
...
const unsigned short HIT_SOLDIERS[NUM_NATS][5] = {{1556, 1558, 1560, 1562, 1564},
