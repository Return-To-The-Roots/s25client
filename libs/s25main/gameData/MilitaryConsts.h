...
const helpers::MultiArray<int, NUM_NATIONS, NUM_MILITARY_BLDS> NUM_TROOPS = {
  {{2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}, {2, 3, 6, 9}}};

/// Gold in den einzelnen Militärgebäuden und nach Nation
const helpers::MultiArray<unsigned short, NUM_NATIONS, NUM_MILITARY_BLDS> NUM_GOLDS = {
...
const helpers::MultiArray<DrawPoint, NUM_NATIONS, NUM_MILITARY_BLDS> TROOPS_FLAG_OFFSET = {
...
const std::array<DrawPoint, NUM_NATIONS> TROOPS_FLAG_HQ_OFFSET = {
  {{-12, -102}, {-19, -94}, {-18, -112}, {20, -54}, {-33, -81}}};

/// Offset of the border indicator flag per nation from the buildings origin
const helpers::MultiArray<DrawPoint, NUM_NATIONS, NUM_MILITARY_BLDS> BORDER_FLAG_OFFSET = {
...
const helpers::MultiArray<unsigned char, NUM_NATIONS, NUM_SOLDIER_RANKS> HITPOINTS = {
...
const FightAnimation FIGHT_ANIMATIONS[NUM_NATIONS][NUM_SOLDIER_RANKS][2] = {
  // Nubier
  {// Schütze (Rang 1)
  ...
  {// Schütze (Rang 1)
   {{{444, 445, 446, 447, 448, 446, 445, 444},
     {{922, 922, 917, 918, 919, 920, 921, 922},
      {917, 918, 925, 926, 927, 928, 929, 930},
      {931, 932, 933, 934, 935, 935, 935, 935}}},
   ...
   {{{457, 458, 459, 460, 461, 462, 463, 464},
     {{961, 962, 963, 964, 965, 966, 967, 967},
      {968, 969, 970, 971, 972, 973, 974, 968},
      {977, 978, 979, 980, 981, 982, 982, 976}}},
   ...
   {{{465, 466, 467, 468, 469, 470, 471, 472},
     {{985, 986, 987, 988, 989, 990, 991, 992},
      {985, 993, 994, 995, 996, 996, 997, 997},
      {998, 999, 1000, 1001, 1002, 1003, 1004, 998}}},
  ...
  {// Schütze (Rang 1)
   {{{364, 365, 366, 367, 368, 369, 370, 371},
     {{670, 671, 672, 673, 674, 675, 676, 676},
      {677, 678, 679, 680, 681, 675, 682, 683},
      {684, 685, 686, 687, 688, 689, 690, 690}}},
    {{404, 405, 406, 407, 408, 409, 410, 411},
     {{784, 785, 786, 787, 788, 789, 790, 790},
      {791, 792, 793, 794, 795, 789, 796, 797},
      {795, 796, 797, 798, 799, 800, 801, 802}}}},
   // Gefreiter (Rang 2)
   {{{372, 373, 374, 375, 376, 377, 378, 379},
     {{691, 692, 693, 694, 695, 696, 697, 697},
      {698, 699, 700, 701, 702, 696, 703, 704},
      {705, 706, 707, 708, 709, 710, 711, 705}}},
    {{412, 413, 414, 415, 416, 417, 418, 419},
     {{805, 806, 807, 808, 809, 810, 811, 805},
      {812, 813, 814, 815, 816, 810, 817, 818},
      {819, 820, 821, 822, 823, 824, 825, 819}}}},
   ...
   {{{380, 381, 382, 383, 384, 385, 386, 387},
    ...
    {{420, 421, 422, 423, 424, 425, 426, 427},
     {{826, 827, 828, 829, 830, 831, 832, 833},
      ...
      {842, 843, 844, 845, 846, 847, 840, 841}}}},
   // Offizier (Rang 4)
   {{{388, 389, 390, 391, 392, 393, 394, 395},
    ...
    {{428, 429, 430, 431, 432, 433, 434, 435},
     {{850, 851, 852, 853, 854, 855, 856, 857},
      ...
      {864, 865, 866, 867, 868, 869, 870, 864}}}},
   // General (Rang 5)
...
const helpers::MultiArray<unsigned short, NUM_NATIONS, NUM_SOLDIER_RANKS> HIT_SOLDIERS = {
