...
constexpr std::array Portraits{PortraitInfo{gettext_noop("Octavianus"), ResourceId("io"), 263},
                               PortraitInfo{gettext_noop("Julius"), ResourceId("io"), 251},
                               PortraitInfo{gettext_noop("Brutus"), ResourceId("io"), 252},
                               PortraitInfo{gettext_noop("Erik"), ResourceId("io"), 261},
                               PortraitInfo{gettext_noop("Knut"), ResourceId("io"), 256},
