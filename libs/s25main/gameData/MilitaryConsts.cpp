...
const helpers::EnumArray<helpers::MultiArray<FightAnimation, NUM_SOLDIER_RANKS, 2>, Nation> FIGHT_ANIMATIONS = []() {
    std::remove_const_t<decltype(FIGHT_ANIMATIONS)> result;
    result[Nation::Africans] = {{// Private (Rank 0)
    ...
    result[Nation::Japanese] = {{// Private (Rank 0)
    ...
    result[Nation::Romans] = {{// Private (Rank 0)
    ...
    result[Nation::Vikings] = {{// Private (Rank 0)
    ...
    result[Nation::Babylonians] = {{// Private (Rank 0)
...
const helpers::EnumArray<std::array<uint16_t, NUM_SOLDIER_RANKS>, Nation> HIT_SOLDIERS = {
