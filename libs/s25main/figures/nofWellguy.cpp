...
{
    const std::array<DrawPointInit, NUM_NATS> offsets = {{{-20, 17}, {-18, 17}, {-20, 13}, {-20, 15}, {-18, 17}}};

    const helpers::SimpleMultiArray<DrawPointInit, NUM_NATS, 8> walkoffsets = // nation, schritt
      {{{{7, 7}, {9, 9}, {5, 12}, {2, 14}, {-1, 17}, {-4, 17}, {-7, 17}, {-10, 17}},
        ...
        {{4, 4}, {8, 8}, {5, 12}, {2, 14}, {-1, 17}, {-3, 19}, {-6, 19}, {-8, 19}}}};
    helpers::SimpleMultiArray<signed char, NUM_NATS, 6> walkdirection = {
