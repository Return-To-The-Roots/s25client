...
public:
    ...
    nofBuildingWorker(const Job job, const MapPoint pos, unsigned char player, nobUsual* workplace);
    nofBuildingWorker(const Job job, const MapPoint pos, unsigned char player, nobBaseWarehouse* goalWh);
