...
#pragma once
#ifndef libs_common_include_helpers_containerUtils_h
#define libs_common_include_helpers_containerUtils_h
...
#endif // !libs_common_include_helpers_containerUtils_h
