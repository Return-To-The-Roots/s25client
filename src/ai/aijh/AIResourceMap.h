...
public:
    ...
    MapPoint FindGoodPosition(const MapPoint& pt, int threshold, BuildingQuality size, int radius = -1, bool inTerritory = true);
    ...
    MapPoint FindBestPosition(const MapPoint& pt, BuildingQuality size, int minimum, int radius = -1, bool inTerritory = true);
    MapPoint FindBestPosition(const MapPoint& pt, BuildingQuality size, int radius = -1, bool inTerritory = true)
    {
