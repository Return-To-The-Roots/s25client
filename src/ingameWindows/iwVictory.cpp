    ...
    : IngameWindow(CGI_VICTORY, IngameWindow::posLastOrCenter, Extent(240, 240), _("End of game"), LOADER.GetImageN("io", 5))
{
    ...
    AddTextButton(ID_CONTINUE, DrawPoint(50, btPosY), Extent(140, 20), TC_GREEN2, _("Continue game"), NormalFont);
    AddTextButton(ID_END_GAME, DrawPoint(50, btPosY + 25), Extent(140, 20), TC_RED1, _("End game"), NormalFont);
}
