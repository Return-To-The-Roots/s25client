...
{
    // Dateiname ins Edit schreiben, wenn wir entsprechende EintrÃ¤ge auswÃ¤hlen
...
iwSave::iwSave() : iwSaveLoad(40, _("Save game!"))
{
    ...
    // UngÃ¼ltig oder 0 --> Deaktiviert auswÃ¤hlen
    if(!found)
