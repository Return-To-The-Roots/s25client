...
ENUM_WITH_STRING(AddonId, LIMIT_CATAPULTS = 0x00000000, INEXHAUSTIBLE_MINES = 0x00000001, REFUND_MATERIALS = 0x00000002,
                 ...
                 CHANGE_GOLD_DEPOSITS = 0x00200000, MAX_WATERWAY_LENGTH = 0x00200001, CUSTOM_BUILD_SEQUENCE = 0x00200002,
                 ...
                 MAX_RANK = 0x00900000, SEA_ATTACK = 0x00900001, INEXHAUSTIBLE_FISH = 0x00900002, MORE_ANIMALS = 0x00900003,
                 BURN_DURATION = 0x00900004, NO_ALLIED_PUSH = 0x00900005, BATTLEFIELD_PROMOTION = 0x00900006,
                 HALF_COST_MIL_EQUIP = 0x00900007, MILITARY_CONTROL = 0x00900008,
                 ...
                 FRONTIER_DISTANCE_REACHABLE = 0x00D0000, COINS_CAPTURED_BLD = 0x00D0001, IMPROVED_WARE_ORDER = 0x00D0002)
//-V:AddonId:801
