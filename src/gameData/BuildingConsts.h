...
const BldWorkDescription USUAL_BUILDING_CONSTS[BUILDING_TYPES_COUNT - FIRST_USUAL_BUILDING] = {
  ...
  BldWorkDescription(JOB_FORESTER),
...
const DrawPointInit NUBIAN_MINE_FIRE[4] = {
