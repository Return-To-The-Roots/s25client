...
const signed char DOOR_CONSTS[NAT_COUNT][BUILDING_TYPES_COUNT] = {
  // Nubier
  ...
  // Babylonians
  {9, 5, 5, 0, 12, 0, 0, 0, 0, 7, 8, 8, 8, 8, 5, 0, 10, 9, 5, 3, 9, 10, 3, 12, 10, 13, 7, 0, -8, 14, 0, 11, 10, 9, 11, 11, 15, -7, -5, 16}};
