...
void LuaPlayer::Register(kaguya::State& state)
{
    state["Player"].setClass(kaguya::ClassMetatable<LuaPlayer>()
        .addMemberFunction("EnableBuilding", &EnableBuilding)
        .addMemberFunction("DisableBuilding", &DisableBuilding)
        .addMemberFunction("EnableAllBuildings", &EnableAllBuildings)
        .addMemberFunction("DisableAllBuildings", &DisableAllBuildings)
        .addMemberFunction("SetRestrictedArea", &SetRestrictedArea)
        .addMemberFunction("ClearResources", &ClearResources)
        .addMemberFunction("AddWares", &AddWares)
        .addMemberFunction("AddPeople", &AddPeople)
        .addMemberFunction("GetBuildingCount", &GetBuildingCount)
        .addMemberFunction("GetWareCount", &GetWareCount)
