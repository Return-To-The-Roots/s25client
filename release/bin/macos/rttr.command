...
chmod 0755 ./rttr.command ./libexec/RTTR/s25update ./bin/s25client ./bin/s25edit ./libexec/RTTR/sound-convert
...
if [ ! "$2" = "noupdate" ] ; then
	if [ -f ./libexec/RTTR/s25update ] ; then
		(cd ../../../ && ./s25client.app/Contents/MacOS/libexec/RTTR/s25update -d "$PWD")
